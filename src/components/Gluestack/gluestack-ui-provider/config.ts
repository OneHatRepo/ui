...
export const config = {
	...
	light: vars({
		...
		'--color-grey-50': '246 246 246',
		'--color-grey-100': '242 241 241',
		'--color-grey-200': '220 219 219',
		'--color-grey-300': '213 212 212',
		'--color-grey-400': '162 163 163',
		'--color-grey-500': '142 142 142',
		'--color-grey-600': '116 116 116',
		'--color-grey-700': '83 82 82',
		'--color-grey-800': '65 64 64',
		'--color-grey-900': '39 38 37',
		'--color-grey-950': '24 23 24',

		// ui elements
		'--color-selected': '#ff0',
		'--color-hover': '#000',
		'--color-selectedHover': '#cc0',
		'--color-unselected': '#bbb',
		'--color-disabled': '#ccc',
		
		'--color-primary-0': '236 255 255',
		'--color-primary-50': '218 251 255',
		'--color-primary-100': '174 235 255',
		'--color-primary-200': '128 220 252',
		'--color-primary-300': '80 205 249',
		'--color-primary-400': '35 191 245',
		'--color-primary-500': '10 165 220',
		'--color-primary-600': '0 129 172',
		'--color-primary-700': '0 92 124',
		'--color-primary-800': '0 56 77',
		'--color-primary-900': '0 20 30',
